...
struct stats_record {
	struct record stats[XDP_ACTION_MAX]; /* Assignment#2: Collect all XDP actions stats */
};
			...
			struct stats_record *stats_prev)
{
	...
	/* Assignment#2: Print all XDP actions stats  */
...
{
	/* Assignment#2: Collect all XDP actions stats  */
	__u32 key;
